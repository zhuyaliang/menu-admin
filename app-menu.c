...
create_item_context_menu (GtkWidget   *item)
{
    ...
    menuitem = gtk_menu_item_new_with_mnemonic ("Add this launcher to _panel");
    gtk_menu_shell_append (GTK_MENU_SHELL (menu), menuitem);
    gtk_widget_show (menuitem);
    
    menuitem = gtk_menu_item_new_with_mnemonic ("Add this launcher to _desktop");
    gtk_menu_shell_append (GTK_MENU_SHELL (menu), menuitem);
    gtk_widget_show (menuitem);
    ...
    menuitem = gtk_menu_item_new_with_mnemonic ("_Entire menu");
    gtk_menu_item_set_submenu (GTK_MENU_ITEM (menuitem), submenu);
    gtk_menu_shell_append (GTK_MENU_SHELL (menu), menuitem);
    gtk_widget_show (menuitem);

    menuitem = gtk_menu_item_new_with_mnemonic ("Add this as _drawer to panel");
    gtk_menu_shell_append (GTK_MENU_SHELL (submenu), menuitem);
    gtk_widget_show (menuitem);

    menuitem = gtk_menu_item_new_with_mnemonic ("Add this as _menu to panel");
    gtk_menu_shell_append (GTK_MENU_SHELL (submenu), menuitem);
    gtk_widget_show (menuitem);
